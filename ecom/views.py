...
def home_view(request):
    ...
    sleeve_length = request.GET.get('sleeve_length')
    neck_type = request.GET.get('neck_type')
    ...
    if sleeve_length:
        products = products.filter(sleeve_length=sleeve_length)
    if neck_type:
    ...
    context = {
        ...
        'SleeveLength': models.Product.SleeveLength,
        'NeckType': models.Product.NeckType,
        'Pattern': models.Product.Pattern,
        'Occasion': models.Product.Occasion,
    }
